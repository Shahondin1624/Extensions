...
public final class UnequalLengthTuple_3Iterator<A, B, C> implements Tuple_3Iterator<Option<A>, Option<B>, Option<C>>, UnequalLengthTupleIterator {
    private final Iterator<A> first;
    private final Iterator<B> second;
    private final Iterator<C> third;

    UnequalLengthTuple_3Iterator(Iterator<A> first, Iterator<B> second, Iterator<C> third) {
        this.first = first;
        this.second = second;
        this.third = third;
    }
